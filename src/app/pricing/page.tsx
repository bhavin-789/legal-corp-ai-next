      ...
      <section className="py-16 md:py-24 bg-gradient-to-br from-primary/5 to-primary/10">
        <div className="container-default px-4">
          <div className="text-center max-w-4xl mx-auto">
            ...
            {intl.formatMessage({ id: "pricing.hero.description" })}
            </p>
        ...
        <div className="container-default px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              {intl.formatMessage({ id: "pricing.comparison.description" })}
              </p>
            </div>
        ...
        <div className="container-default px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-muted-foreground">
              {intl.formatMessage({ id: "pricing.faq.description" })}
              </p>
            </div>
              ...
              <div className="space-y-6">
                <div className="bg-muted/30 rounded-lg p-6">
                  ...
                  <p className="text-muted-foreground">
                    ...
                    bancarias. Para planes empresariales, también ofrecemos
                    facturación.
                  </p>
                </div>
      ...
      <section className="py-16 bg-primary/5">
        <div className="container-default px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            {intl.formatMessage({ id: "pricing.readyToTransformSection.title" })}
            </h2>
            <p className="text-xl text-muted-foreground mb-8">
            {intl.formatMessage({ id: "pricing.readyToTransformSection.description" })}
            </p>

            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" asChild>
                <Link href="/signup">
                {intl.formatMessage({ id: "pricing.readyToTransformSection.getStartedButton" })}
                  <ArrowRight className="ml-2 h-5 w-5" />
                </Link>
              </Button>
              <Button variant="outline" size="lg" asChild>
                <Link href="/contact">
                {intl.formatMessage({ id: "pricing.readyToTransformSection.contactSalesButton" })}
                </Link>
              </Button>
            </div>
          </div>
