    ...
    <>
                        ...
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <p className="text-sm font-bold">
                              {billingStats.nextPayment.split(" ")[0]}
                            </p>
                          </div>
      ...
      <Dialog open={showUpgradeDialog} onOpenChange={setShowUpgradeDialog}>
        <DialogContent>
          ...
          <div className="space-y-4">
            <p>
              ¿Estás seguro que quieres actualizar tu plan? Serás redirigido a
              la página de precios para seleccionar un nuevo plan.
            </p>
            <div className="flex justify-end space-x-2">
              ...
              <Button onClick={confirmUpgrade}>Ver Planes</Button>
            </div>
          </div>
        </DialogContent>
      </Dialog>
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm text-yellow-800">
                  Tu acceso continuará hasta el final del período de facturación
                  actual.
                </span>
              </div>
            </div>
