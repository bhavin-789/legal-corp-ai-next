...
export function FeatureComparison() {
  return (
    <Card className="overflow-hidden">
      <CardHeader>
        <CardTitle className="text-2xl">Comparación de Características</CardTitle>
      </CardHeader>
      <CardContent>
              ...
              <tr className="border-b">
                ...
                <th className="text-center py-4 px-4 font-medium">
                  <div className="flex flex-col items-center">
                    ...
                    <span className="text-sm text-muted-foreground">$0/mes</span>
                  </div>
                </th>
                <th className="text-center py-4 px-4 font-medium">
                  <div className="flex flex-col items-center">
                    ...
                    <span className="text-sm text-muted-foreground">$29/mes</span>
                  </div>
                </th>
                <th className="text-center py-4 px-4 font-medium">
                  <div className="flex flex-col items-center">
                    <span className="font-medium">Firm</span>
                    <span className="text-sm text-muted-foreground">$99/mes</span>
                  </div>
                </th>
              </tr>
            </thead>
                ...
                <tr key={index} className="border-b last:border-b-0">
                  ...
                  {feature.name === "Número de GPTs" ? (
                    <>
                      ...
                      <td className="text-center py-4 px-4">
                        <span className="text-sm font-medium">{planDetails.pro.gpts}</span>
                      </td>
                      <td className="text-center py-4 px-4">
                        <span className="text-sm font-medium">{planDetails.firm.gpts}</span>
                      </td>
                    </>
                  ) : feature.name === "Documentos por mes" ? (
                    <>
                      <td className="text-center py-4 px-4">
                        <span className="text-sm">{planDetails.free.documents}</span>
                      </td>
                      <td className="text-center py-4 px-4">
                        <span className="text-sm font-medium">{planDetails.pro.documents}</span>
                      </td>
                      <td className="text-center py-4 px-4">
                        <span className="text-sm font-medium">{planDetails.firm.documents}</span>
                      </td>
                    </>
                  ) : (
                    <>
